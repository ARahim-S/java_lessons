...
public class IfStatements04 {
    public static void main(String[] args) {
        ...
        //Çözüme ulaşmak için gereksinimleri çok iyi anlamak gerekir.
        /*
        Bu soruda önce en dıştan yani en soldan başlayarak kodu yazmak gerekiyor.
        0 dan küçük olanlardan başlayarak 30 un dışına kadar devam etemek
        gerekiyor.
         */
        /*
        IMPORTANT
        If statements larda parantez içini sade tutmak best practice tir.
        Okunaklu olması ve clean kod olması önemlidir.
        (age>=0 && age<=4) bu örnek karmaşık ve best practice aykırıdır.
         */
